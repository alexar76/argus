...
**Built-in protections:**
- **WARDEN firewall:** static scan → threat feed → origin → pinning → drift detection
...
| MCP tool poisoning | Malicious MCP server | WARDEN: static scan + threat feed + origin + pinning |

...
| **Lumen** | Reputation / trust (PageRank / EigenTrust) | `lumen.reputation@v1` — scores the trust graph a caller supplies; **WARDEN does not call it** |
...
|---------|---------|-----------|
| `warden.oracleFamilyUrl` | `https://oracles.modelmarket.dev/family` | Endpoint LUMEN del `LumenOracle` del runtime (`argus passport`); ninguna puerta de WARDEN lo lee |

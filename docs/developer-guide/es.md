...
Para compradores automatizados, usa `argus economy invoke` o configura auto-approve para capabilities de confianza. Ver [guía de usuario — HTTP API](../user-guide/es.md#6--canales--formas-de-alcanzar-tu-agente).

# 15 मिनट में capability प्रकाशित करें (हिन्दी)

> HTTP सर्वर · मैनिफेस्ट · Hub CLI · ARGUS से USDC
...
`hello-capability` — `python3 server.py` → :3456. `provider_pubkey` प्रिंट करता है; `X-Provider-Signature` हेडर।
...
## 2b · Stake और सुरक्षा (prod)

Production: **stake** (≥ $10), rate limits, **LUMEN trust**, Ed25519 signed responses. पहले stake जमा करें:
...
CLI install, token, prod पर stake, फिर publish.
...
ARGUS `ARGUS_MIN_HUB_TRUST` (0.25) से नीचे की listings हटाता है।

---

- [Ecosystem whitepaper (EN)](https://github.com/alexar76/aicom/blob/main/docs/ecosystem/whitepaper/en.md)
- [Hello-capability example](https://github.com/alexar76/aimarket-hub/tree/main/examples/hello-capability/)
- [GitHub Issues](https://github.com/alexar76/argus/issues)
- [User guide (हिन्दी)](../user-guide/hi.md)

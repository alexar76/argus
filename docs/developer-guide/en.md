...
For automated buyers, use `argus economy invoke` or configure tool auto-approve for trusted capabilities. See [user guide — HTTP API](../user-guide/en.md#6--channels--ways-to-reach-your-agent).

...
Для автоматизированных покупателей используйте `argus economy invoke` или настройте auto-approve для доверенных capabilities. См. [руководство пользователя — HTTP API](../user-guide/ru.md#6--каналы--способы-связи-с-агентом).

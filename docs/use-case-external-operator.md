...
> 🌐 Language: **English** · [Русский](./use-case-external-operator-ru.md) · [Español](./use-case-external-operator-es.md)
...
> [Onboard a new node](https://github.com/alexar76/aicom/blob/main/docs/onboard-a-node.md) (supply-side services) ·
...
See [uni-corporate-usecase.md](https://github.com/alexar76/aicom/blob/main/docs/uni-corporate-usecase.md).
...
| [Onboard a new node](https://github.com/alexar76/aicom/blob/main/docs/onboard-a-node.md) | Custom HTTP service (not ARGUS) as a node |

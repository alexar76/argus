...
> 🌐 Язык: [English](./use-case-external-operator.md) · **Русский** · [Español](./use-case-external-operator-es.md)
...
>
> См. также: [economy-integration.md](./economy-integration.md) ·
> [autonomy.md](./autonomy.md) ·
> [Onboard a new node](https://github.com/alexar76/aicom/blob/main/docs/onboard-a-node.md) ·
> [Developer guide](./developer-guide/ru.md)
...
[uni-corporate-usecase.md](https://github.com/alexar76/aicom/blob/main/docs/uni-corporate-usecase.md).
...
| Документ | Когда |
|-----|------|
| [economy-integration.md](./economy-integration.md) | Диаграммы SDK, справочник конфигурации |
| [mcp-oracles-capabilities.md](./mcp-oracles-capabilities.md) | 17 оракулов, MCP, продажа |
| [security-warden.md](./security-warden.md) | Шлюзы MCP-файрвола |
| [Onboard a new node](https://github.com/alexar76/aicom/blob/main/docs/onboard-a-node.md) | Свой HTTP-сервис как узел (не ARGUS) |
| [Developer guide (20 langs)](./developer-guide/) | Опубликовать hello-capability за 15 мин |

...
Tek satırlık kurulumu çalıştırın. Node.js 20+ kontrol, `@alexar76/argus3` global kurulum, `~/.argus/agent` oluşturma, `argus setup` başlatma. Sihirbaz: crypto cüzdan (isteğe bağlı, varsayılan KAPALI), ortam modu, LLM sağlayıcı, Telegram, HTTP token.

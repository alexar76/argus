...
Pokrenite jednolinijski instalator. Provjerava Node.js 20+, globalno instalira `@alexar76/argus3`, stvara `~/.argus/agent` i pokreće `argus setup`. Čarobnjak: kripto novčanik (opcionalno, default OFF), okruženje, LLM provider, Telegram, HTTP token.

...
एक-पंक्ति इंस्टॉलर चलाएँ। Node.js 20+ जाँच, `@alexar76/argus3` global install, `~/.argus/agent` बनाएगा, `argus setup` शुरू करेगा। विज़ार्ड: crypto wallet (वैकल्पिक, डिफ़ॉल्ट OFF), environment mode, LLM provider, Telegram, HTTP token।

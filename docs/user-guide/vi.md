...
Chạy lệnh cài một dòng. Kiểm tra Node.js 20+, cài `@aimarket/argus` global, tạo `~/.argus/agent`, khởi chạy `argus setup`. Trình hướng dẫn: ví crypto (tùy chọn, mặc định TẮT), chế độ môi trường, nhà cung cấp LLM, Telegram, token HTTP.

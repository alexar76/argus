...
Это дополняет [architecture.md](./architecture-ru.md#ограниченный-цикл-агента) (где эти рычаги находятся в цикле) и [economy-integration.md](./economy-integration.md) (расход на вызов, который они ограничивают).

...
flowchart LR
  ...
  ORACLES["🔮 Oracles (16 + Platon)<br/>LUMEN · Platon · Chronos · Lattice<br/>Murmuration · Colony · Turing · Percola<br/>Fermat · Ablation · Landauer · Sortes<br/>Gauss · Aestus · Betti · Kantor · Fourier"] --> HUB
...
- 🛒 **AIMarket Hub + Protocol v2** — the marketplace/broker. Capabilities are
  ...
  itself as a seller.
- 🔮 **Oracles (16 + Platon)** — verifiable math services ARGUS can call and pay for:

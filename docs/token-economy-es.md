...
Esto complementa [architecture.md](./architecture-es.md#el-bucle-de-agente-acotado) (dónde se sitúan estos controles en el bucle) y [economy-integration.md](./economy-integration.md) (el gasto por llamada que acotan).

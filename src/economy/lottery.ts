  ...
  const enter: Tool = {
    ...
    run: async (args, ctx) => {
      ...
      try {
        ...
        // I6 fix: re-read roundId after simulation to confirm it hasn't advanced.
        // Between the initial read and the transaction submission the round could
        // close, causing the buy to revert. A stale-round check catches this before
        // we waste gas on a doomed transaction.

import type { Logger, MemoryStore, MeterSnapshot, Message, Tool, ToolCall } from "../types.js";
...
export class Agent {
  ...
  async run(
    ...
    return { answer, meter: budget.snapshot(), outcome, provenance: provenance.list(), audit: agentAudit };
  }
